...
export interface GameProps{locale:Locale;difficulty:PokeDifficulty;generationCap:number;roundCount:5|10|20;runSeed:string;onFinish:(score:number,correct:number,total:number,speciesIds:number[])=>void}
